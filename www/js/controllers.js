...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $sce, DataLoader, $rootScope, $log ) {
  ...
  $rootScope.url = 'http://www.atcconsultoria.com/blog/wp-json/wp/v2/';
...
.controller('PostsCtrl', function( $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log ) {
  ...
  var postsApi = $rootScope.url + 'posts?filter[cat]=2';
...
.controller('GatosCtrl', function( 
  $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log ) {

  var postsApi = $rootScope.url + 'posts?filter[cat]=1';
...
.controller('IntroCtrl', function($scope, $state, $ionicSlideBoxDelegate, $ionicHistory,$cordovaCamera) {
...
/*controlador lecturas*/

.controller('LecturasCtrl', function( 
  $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log ) {

  var postsApi = $rootScope.url + 'posts?filter[cat]=5';
...
/*fin controlador lecturas*/

.controller('AcercaCtrl', function($scope, $state, $ionicSlideBoxDelegate, $ionicHistory) {
